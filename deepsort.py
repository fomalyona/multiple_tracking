...
class deepsort_rbc():
    def __init__(self,max_cosine_distance, wt_path=None ):
        ...
        self.metric = nn_matching.NearestNeighborDistanceMetric("cosine", self.max_cosine_distance , 100)
    ...
    def run_deep_sort(self, frame, out_scores, out_boxes):
        ...
        # features = self.encoder(frame, out_boxes)
        ...
        dets = [Detection(bbox, score, feature) for bbox, score, feature in zip(out_boxes, out_scores, features)]
